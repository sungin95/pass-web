...
@SpringBootTest(
        ...
        classes = {com.fastcampus.pass.util.FormDataEncoder.class, ObjectMapper.class}
)
class FormDataEncoderTest {


    private final com.fastcampus.pass.util.FormDataEncoder formDataEncoder;

    FormDataEncoderTest(@Autowired com.fastcampus.pass.util.FormDataEncoder formDataEncoder) {
